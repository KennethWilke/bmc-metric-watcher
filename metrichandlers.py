...
graphite_host = 'zabbix.gie.rackspace.net'
last_datasets = {}
...
kwilke@kbawx:~/workprojects/bmc-metric-funnel$ ls
bmc-funnel.py  handlers.py  README.md  requirements.txt  venv
kwilke@kbawx:~/workprojects/bmc-metric-funnel$ cat handlers.py 
